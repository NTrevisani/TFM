...
VQE
===
python mkQbitsComparison.py mean VQE
python mkQbitsComparison.py cvar_0.5 VQE
python mkQbitsComparison.py cvar_0.2 VQE

QAOA
====
python mkQbitsComparison.py mean QAOA
python mkQbitsComparison.py cvar_0.5 QAOA
python mkQbitsComparison.py cvar_0.2 QAOA
"""
...
for i in range(len(N_QBITS)):
    load_string = "../files/{0}/{1}qbits_{2}edges_{3}/Scan".format(n_algo, N_QBITS[i], E[i], COST) 
...
folder_name = "figures/{0}/{1}_comparison/".format(n_algo, COST)
